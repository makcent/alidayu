...
class Sms extends Component
{
	...
	public $product = "Dysmsapi";//产品名称:云通信短信服务API产品,开发者无需替换
	public $domain = "dysmsapi.aliyuncs.com";//产品域名,开发者无需替换
	public $accessKeyId = "yourAccessKeyId"; // AccessKeyId
	public $accessKeySecret = "yourAccessKeySecret"; // AccessKeySecret
	public $region = "cn-hangzhou";// 暂时不支持多Region
	public $endPointName = "cn-hangzhou";// 服务结点
	public $protocol = 'http';//可选-启用https协议
    ...
    public function sendSms() {
		return new SendSmsRequest();//返回实例化对象，参数有外部设置
